// @(#)root/eve:$Id: TEveVSDStructs.h 38721 2011-04-04 13:37:12Z matevz $
...
public:
   ...
   Double32_t  	 fDcaZ;   		// dca z to the primary vertex
	Double32_t  	 fPVX;   		// dca z to the primary vertex
	Double32_t  	 fPVY;   		// dca z to the primary vertex
	Double32_t  	 fPVZ;   		// dca z to the primary vertex
   // PID data missing
