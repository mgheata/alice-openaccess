...
public:
    ...
    TGMainFrame(p, w, h)
  {
    ...
    b1 = new TGPictureButton(hf, gClient->GetPicture("eve_files/k0_2.png"));
  ...
  void ShowALICE2()
  {
    ...
    b1->SetPicture(gClient->GetPicture("eve_files/k0_2.png"));
    b1->DoRedraw();
  ...
  void ShowITS2()
  {
    ...
    b1->SetPicture(gClient->GetPicture("eve_files/lambda_2.png"));
    b1->DoRedraw();
  ...
  void ShowTRDTOF2()
  {
    ...
    b1->SetPicture(gClient->GetPicture("eve_files/xi_2.png"));
    b1->DoRedraw();
...
public:
    ...
    TGMainFrame(p, w, h)
  {
    ...
    TGGroupFrame* gf = new TGGroupFrame(this, "Calculator Instructions");
  ...
  hf = new TGHorizontalFrame(gf, 250, 20, kFixedWidth);
    ...
    TGTextButton* b = new TGTextButton(hf, "Invariant Mass");
...
*/
    ...
    b = new TGTextButton(gf, "That's an Anti-Lambda!");
    ...
    //---------------------------------------------------------------------------
 	...
 	b = new TGTextButton(gf, "That's a background!");
...
*/
    ...
    TGTextButton *b = new TGTextButton(gf, "Close");
...
\
   ");
	...
	instructions->SetText("\
Welcome to the <Student> mode, here you see all the tools you need to analyse\n\
the ALICE Events.\n\n\
\
On the right hand side you can see the events in 3 views.\n\
...
");
  ...
  void StudentSet(){
	...
	b = new TGTextButton(hf,"Analysis Instructions");
	hf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
...
//---------------------
    ...
    gf = new TGGroupFrame(frmMain, "Strange Particles");
	...
	b = new TGTextButton(hf, "Table of Results");
	hf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
...
*/
    ...
    */
	...
	b = new TGTextButton(frmMain,"I'm ready! Start Exercise");
	b->SetTextColor(buttonRedColor);
	b->SetFont(buttonFont);
...
*/
...

    {
      ...
      ULong_t buttonRedColor;
      gClient->GetColorByName("red", buttonRedColor);
      b = new TGTextButton(vf,"Global Instructions");
      b->SetTextColor(buttonRedColor);
      b->SetFont(buttonFont);
      vf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
      b->Connect("Clicked()", "TVSDReader", this, "Instructions()");
...

    {
      ...
      b = new TGTextButton(vf,"Get Files");
      vf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
      b->Connect("Clicked()", "TVSDReader", this, "UploadResults()");

      b = new TGTextButton(vf,"Save Histograms");
      vf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
    ...
    gf = new TGGroupFrame(frmMain, "Results");

    vf = new TGVerticalFrame(gf, 200, 20, kFixedWidth);

    {

      b = new TGTextButton(vf, "Table of Results");
      vf->AddFrame(b, new TGLayoutHints(kLHintsExpandX, 1, 1, 1, 1));
      b->Connect("Clicked()", "TVSDReader", this, "CountStrangeParticles()");
...
*/
  ...
  void Autosave()
  {
    ...
    ofstream myresult(TString::Format("autosave.masterclass.%d",fCurEv+1));
